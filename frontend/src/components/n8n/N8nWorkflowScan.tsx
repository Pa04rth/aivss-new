    ...
    return (
      <div className="bg-card border rounded-xl p-8 md:p-12 w-full max-w-3xl space-y-8 text-center animate-fade-in mx-auto">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">{scanState.message}</p>
        </div>
        ...
        {connections.length === 0 ? (
          <div className="text-center py-8">
            ...
            <button
              ...
              className="px-6 py-3 bg-primary text-primary-foreground rounded-md font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 mx-auto"
            >
