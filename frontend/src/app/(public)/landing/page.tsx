      ...
      <div className="text-center px-6 max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-gray-400 mt-4 max-w-2xl mx-auto leading-relaxed">
            Secure your multi-agent systems with comprehensive vulnerability
            scanning, risk assessment, and automated hardening recommendations.
          </p>
        </div>
        ...
        <div className="mb-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-gray-400 text-sm">
              ...
              vulnerabilities in your AI agent code.
            </p>
          </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-gray-400 text-sm">
              Comprehensive risk scoring and prioritization to help you focus on
        ...
        <div className="mb-8">
          ...
          <div className="mt-4">
            <Link
              href="/auth/github"
              className="inline-flex items-center px-8 py-4 bg-gray-800 text-white font-semibold rounded-lg hover:bg-gray-700 transition-all duration-200 border border-gray-600"
            >
              <svg
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center items-center space-x-8 opacity-60">
            ...
            <div className="text-gray-400 text-sm">🛡️ SOC 2 Compliant</div>
          </div>
        </div>
      </div>
    </div>
